...
- Home-page stage: evidence-based solver overview, original ParaView result image, shared responsive shell, and System/Light/Dark themes.
...
- All eight routes remain noindex during development. Home presents the solver; the original component preview is at `/design-system/`. Other product routes clearly identify their unfinished content. Remaining pages and deployment are pending.
